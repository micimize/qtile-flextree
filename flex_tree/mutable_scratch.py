# lifted wholesale from https://github.com/jrwrigh/qtile-mutable-scratch/blob/master/qtile_mutable_scratch/_MutableScratch.py
# idk why but pip install didnt work
import libqtile
